...
SRCS=./src/containers/string/string.c ./src/containers/token/token_array.c ./src/containers/stack/stack.c ./src/parsing/syntax_tree.c ./src/signals/here_doc_signals.c\
	...
	./src/containers/string/string_mask_manipulation.c
OBJS=$(SRCS:%.c=%.o)
ZEN_LIB=libzen.a
NAME=minishell
CC=cc
